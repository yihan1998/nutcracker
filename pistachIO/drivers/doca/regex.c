...
int doca_regcomp(regex_t *_Restrict_ __preg, const char *_Restrict_ __pattern, int __cflags) {
#if 0
	doca_error_t result;
    int ret;
...
int doca_regexec(const regex_t *_Restrict_ __preg, const char *_Restrict_ __String, size_t __nmatch,
