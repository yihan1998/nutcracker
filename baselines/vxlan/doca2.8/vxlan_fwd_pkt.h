...
#ifndef VXLAN_FWD_PKT_H_
#define VXLAN_FWD_PKT_H_
 ...
 *  classify it.
 */
struct vxlan_fwd_pkt_tun_format {
...
struct vxlan_fwd_pkt_info {
	...
	struct vxlan_fwd_pkt_format outer;	/* Outer packet parsing result */
	enum doca_flow_tun_type tun_type;	/* Tunneling type (GRE, GTP or VXLAN) */
	struct vxlan_fwd_pkt_tun_format tun;	/* Tunneling parsing result*/
	struct vxlan_fwd_pkt_format inner;	/* Inner packet parsing result */
